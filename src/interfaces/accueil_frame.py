...
class AccueilFrame(ttk.Frame):
    ...
    def afficher_accueil(self):
        ...
        message = f"Bienvenue {self.utilisateur.get_nom()} !"  # Utiliser self.utilisateur pour récupérer le nom
        ttk.Label(self, text=message, font=("Helvetica", 16)).pack(pady=30)

        # Affichage en fonction de l'utilisateur
        if isinstance(self.utilisateur, Abonne):  # Vérifier si l'utilisateur est un abonné
    ...
    def afficher_accueil_abonne(self):
        ...
        #ttk.Button(self, text="Louer un velo", command=self.controller.afficher_velos).pack()
        ttk.Button(self, text="Affichage historique trajets", command=self.controller.afficher_trajets).pack()
    ...
    def afficher_accueil_admin(self):
        ...
        ttk.Button(self, text="Gestion des stations", command=lambda: self.controller.afficher_stations(self.utilisateur)).pack()
