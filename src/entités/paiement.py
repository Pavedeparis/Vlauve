...
class Paiement:
    ...
    # Getters
    def get_id_paiement(self): return self.id_paiement
    def get_facture(self): return self.facture
    def get_date(self): return self.date
    def get_montant(self): return self.montant

    # Setters
    def set_id_paiement(self, id_paiement): self.id_paiement = id_paiement
    def set_facture(self, facture): self.facture = facture
